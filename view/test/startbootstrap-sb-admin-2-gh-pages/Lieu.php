...
<head>
    ...
    <link rel="stylesheet" href="css/tableauDeBoard.css">
    <link
...
/*include("../../../Controller/AfficherArticle.php"); */
 ...
 <div id="container">
   ...
   ?> -->
        ...
        <input type="text" name="queryy" id="searchText" class="form-control" />
        <input type="button" value="Search" name="search"  id="search"  class="form-control"/>
