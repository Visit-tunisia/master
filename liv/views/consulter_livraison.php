...
<body>
    ...
    <?PHP
        ...
        $livraison=$livraisonC->afficherlivraisonsadmin();
        $livreur=$livreurC->afficherlivreurs2();
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="menu-icon fa fa-street-view"></i><a href="consulter_livreur.php">consulter livreur</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="menu-icon fa fa-street-view"></i><a href="maps-vector.html">consulter livraison</a></li>
                        </ul>
                    </li>
...
foreach($livraison as $row){
    ...
    <?php if ($row['etat']=='non_traiter'){  
        ?>          
	<td><a href="traiter.php?id=<?PHP echo $row['id']; ?>">
    traiter</a></td>
    <?php
    }else{
        ?>
    ...
    <select name="livreur" id="livreur">
          <?php
    foreach($livreur as $row2)
    {
	?>
         
   
    <option value=" <?php echo $row2['nom']; ?>"> <?php echo $row2['nom']; ?> </option>
    <?php
    }
    ?>
    </select>
