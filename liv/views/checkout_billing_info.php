...
$livraison=$livraisonC->selectnotification();
  ...
  <nav>
    ...
    <div class="dropdown for-notification">
                            <button class="btn btn-secondary dropdown-toggle" type="button" id="notification" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <span class="count bg-danger"><?php echo $livraison->rowCount() ;?></span>
                            </button>
                            <div class="dropdown-menu" aria-labelledby="notification">
                                <p class="red">You have  Notification</p>
                                <form method="POST" action="updatenotif.php"> 
                                <a class="dropdown-item media bg-flat-color-1" href="#">
                                <i class="fa fa-check"></i>
                                <p>votre livraison a etait  traiter</p>
        ...
        <div class="col-main col-sm-9">
          ...
          <ol class="one-page-checkout" id="checkoutSteps">
            ...
            <li id="opc-billing" class="section allow active">
              ...
              <form method="POST" action="ajouterliv.php">
<div class="col-md-6">
    ...
    <div class="panel-body">
            <form role="form">
                    <div class="form-group has-success">
                        ...
                        <input type="text" class="form-control" id="success" name="username"/>
                    </div>
                    
                    <div class="form-group has-error">
                        <label class="control-label" for="error">adress</label>
                        <input type="text" class="form-control" id="error" name="adress"/>
                    </div>
                    ...
                    <div class="form-group has-success">
                        ...
                        <input type="date" class="form-control" id="success" name="date"/>
                    </div>
