...
if (isset($_GET['id'])){
    ...
    $result=$livraisonC->recupererlivraison($id);
...
<div class="col-md-6">
    ...
    <div class="panel-body">
            <form role="form" action="modifierlivC.php">
                    <div class="form-group has-success">
                        <label class="control-label" for="success">username</label>
                        <input type="text" value="<?php echo $username?>" class="form-control" id="success" name="username"/>
                    </div>
                    
                    <div class="form-group has-error">
                        <label class="control-label" for="error">adress</label>
                        <input type="text"  value="<?php echo $adress?>"class="form-control" id="error" name="adress"/>
                    </div>
                   
                   
                    <div class="form-group has-success">
                        <label class="control-label" for="success">Saisir le numero du telephone</label>
                        <input type="number"  value="<?php echo $numtel?>"class="form-control" id="success" name="telephone"/>
                    </div>
				
                    <div class="form-group has-success">
                        <label class="control-label" for="success">date </label>
                        <input type="date"  value="<?php echo $date?>" class="form-control" id="success" name="date"/>
                        <input type="hidden"  value="<?php echo $id?>" class="form-control" id="success" name="id"/>
                        <input type="hidden"  value="<?php echo $idclient?>" class="form-control" id="success" name="idclient"/>
                        <input type="hidden"  value="<?php echo $numcommande?>" class="form-control" id="success" name="numcommande"/>
                        <input type="hidden"  value="<?php echo $total?>" class="form-control" id="success" name="total"/>
                        <input type="hidden"  value="<?php echo $etat?>" class="form-control" id="success" name="etat"/>
